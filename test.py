...
b=random.choice(['en','gb','id','ms','de','ru','en','fr','fa','ja','pt','cs','zh','cn','vi','en','in','tr'])
lisa=f'Opera/9.80 (Android; Opera Mini/{str(rr(1,25))}.{str(rr(1,50))}.{str(rr(1000,2999))}/{str(rr(20,250))}.{str(rr(100,500))}; U; {b}) Presto/2.{str(rr(1,25))}.{str(rr(20,200))} Version/{str(rr(1,60))}.{str(rr(10,200))}'
lisa1=f'Opera/9.80 (BlackBerry; Opera Mini/{str(rr(1,25))}.{str(rr(1,50))}.{str(rr(2000,2999))}/{str(rr(20,250))}.{str(rr(100,500))}; U; {b}) Presto/2.{str(rr(1,25))}.{str(rr(20,200))} Version/{str(rr(1,60))}.{str(rr(10,200))}'
lisa2=f'SAMSUNG-GT-{az}{str(rr(2000,9888))}{az} Opera/9.80 (J2ME/MIDP; Opera Mini/{str(rr(1,25))}.{str(rr(1,25))}.{str(rr(2000,4000))}/{str(rr(10,200))}.{str(rr(1000,9000))}; U; {b}) Presto/2.{str(rr(1,25))}.{str(rr(20,200))} Version/{str(rr(1,60))}.{str(rr(10,200))}'
lisa3=f'SAMSUNG-GT-{az}{str(rr(2000,9888))} Opera/9.80 (J2ME/MIDP; Opera Mini/{str(rr(1,25))}.{str(rr(1,25))}.{str(rr(2000,4000))}/{str(rr(10,200))}.{str(rr(1000,9000))}; U; {b}) Presto/2.{str(rr(1,25))}.{str(rr(20,200))} Version/{str(rr(1,60))}.{str(rr(10,200))}'
lisa4=f'SAMSUNG-SM-{az}{str(rr(200,999))}{az} Opera/9.80 (J2ME/MIDP; Opera Mini/{str(rr(1,25))}.{str(rr(1,25))}.{str(rr(2000,4000))}/{str(rr(10,200))}.{str(rr(1000,9000))}; U; {b}) Presto/2.{str(rr(1,25))}.{str(rr(20,200))} Version/{str(rr(1,60))}.{str(rr(10,200))}'
uaku2 = random.choice([lisa,lisa1,lisa2,lisa3,lisa4])
uak.append(uaku2)
def uaku():
	try:
...
def banner():
	clear()
	ricode_xy(f'''\t{asu} ______                                              
\t|_   _ \                                             
\t  | |_) | _ .--.  ,--.   ____   ____  .---.  _ .--.  
\t  |  __'.[ `/'`\]`'_\ : [_   ] [_   ]/ /__\\[ `/'`\] 
\t _| |__) || |    // | |, .' /_  .' /_| \__., | |     	
\t|_______/[___]   \'-;__/[_____][_____]'.__.'[___]    	
			{m}•{k}•{h}•{sir} recode by :Ricode•404 {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
